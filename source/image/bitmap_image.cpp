...
BitmapImage::BitmapImage(const std::uint32_t image_height, const std::uint32_t image_width)
	...
	if (image_height > 1'024'000) throw std::exception{};
	if (image_height == 0) throw std::exception{};
	if (image_width > 1'024'000) throw std::exception{};
	if (image_width == 0) throw std::exception{};
...
void BitmapImage::set_pixel(const std::uint32_t y_position, const std::uint32_t x_position, const BitmapPixel pixel) {
	if (y_position >= height) throw std::exception{};
	if (x_position >= width) throw std::exception{};
